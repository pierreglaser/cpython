...
class AbstractPickleTests(unittest.TestCase):
    ...
    def test_closure_interacting_with_a_global_variable(self):
        ...
        try:
            ...
            cloned_f0 = self.loads(self.dumps(f0), allow_dynamic_objects=True)
            cloned_f1 = self.loads(self.dumps(f1), allow_dynamic_objects=True)
            ...
            result_pickled_f1 = self.loads(pickled_f1,
                                           allow_dynamic_objects=True)()
            # Each time a function f is depickled, pickle sets the values
    ...
    def test_empty_cell_preserved(self):
        ...
        g2 = self.loads(self.dumps(g1), allow_dynamic_objects=True)
        with self.assertRaises(NameError):
            g2()
